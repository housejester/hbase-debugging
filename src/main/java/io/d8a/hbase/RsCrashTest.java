...
public class RsCrashTest {
    ...
    public static void main(String[] args) throws ServiceException, IOException {
        ...
        try {
            table = createTable(hbaseConf, hConnection, table);
    ...
    private static HTableInterface createTable(Configuration hbaseConf, HConnection hConnection, HTableInterface table) throws IOException {
